...
export class SavingsCalculator {
  ...
  private readonly calculateTotalSavings: (
    currentSavings: number,
    totalContributions: number,
    years: number
  ) => number;
  private readonly getMaximumRetirementAge: (retirementAge: number) => number;
   ...
   */
  public calculateProjectedRetirementSavings(
   ...
   */
  public calculateSavingsDuration(
    input: RetirementCalculatorInput,
