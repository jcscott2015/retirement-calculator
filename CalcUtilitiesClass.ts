export class CalcUtilities {
   ...
   */
  public precisionNumber(number: number, precision: number = 2): number {
   ...
   */
  public savingsPayout(p: number, r: number, y: number): number {
    return (
   ...
   */
  public futureValue(p: number, r: number, y: number): number {
   ...
   * ```
   */
  public geometricSeries(a: number, r: number, n: number): number {
